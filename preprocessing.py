...
if __name__ == "__main__":
    ...
    parser.add_argument("a_scan_loc", type=str, default=A_SCAN_PATH)
    parser.add_argument("defect_loc", type=str,default = DEFECT_PATH)
    ...
    Y.to_csv('target_scans.csv')
    #Originally "varios_r_defects_right.csv"
    X_top.to_csv('right_profile_defects.csv')
    #Originally "varios_r_defects_left.csv"
    X_bottom.to_csv('left_profile_defects.csv')
